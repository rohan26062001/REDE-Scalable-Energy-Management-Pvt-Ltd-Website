...
<head>
    ...
    <title>Product Query | REDE Scalable Energy Management Pvt. Ltd.</title>
...
<body>
    ...
    <section class="enquiry">
        <div class="container my-5">
            <h1 class="text-center"><span style="color: #E91E63;">Product Query</span> Details</h1>
            <?php

            include("connection.php");

            $query = "select * from product_query";
